...
namespace NumberToWord
{
    ...
    {
        public enum Currencies { Syria = 0, UAE, SaudiArabia, Tunisia, Gold ,Egypt, Kilo };
        ...
        public CurrencyInfo(Currencies currency)
        {
            switch (currency)
            {
                ...
                case Currencies.Kilo:
                    CurrencyID = 6;
                    CurrencyCode = "Kg";
                    IsCurrencyNameFeminine = false;
                    EnglishCurrencyName = "Kg";
                    EnglishPluralCurrencyName = "Kg";
                    EnglishCurrencyPartName = "g";
                    EnglishPluralCurrencyPartName = "g";
                    Arabic1CurrencyName = "كيلوجرام";
                    Arabic2CurrencyName = "كيلوجرام";
                    Arabic310CurrencyName = "كيلوجرام";
                    Arabic1199CurrencyName = "كيلوجرام";
                    Arabic1CurrencyPartName = "جرام";
                    Arabic2CurrencyPartName = "جرام";
                    Arabic310CurrencyPartName = "جرام";
                    Arabic1199CurrencyPartName = "جرام";
                    PartPrecision = 3;
                    IsCurrencyPartNameFeminine = false;
                    break;
